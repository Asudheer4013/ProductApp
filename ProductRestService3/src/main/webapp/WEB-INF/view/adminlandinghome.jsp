	...
	<!-- END nav -->
		...
		<div class="home-slider owl-carousel">
			<div class="slider-item"
				style="background-image: url(images/cartimage3.jpg);">
				...
				<div class="container">
					<div
						...
						<div class="col-md-12 ftco-animate text-center">
							<h1 class="mb-2">We serve Quality products</h1>
					
							<p>
								<a href="afteradminlogin" class="btn btn-primary">View Details</a>
							</p>
						</div>
				...
				<div class="slider-item"
				style="background-image: url(images/cartimage2.jpg);">
				<div class="overlay"></div>
				<div class="container">
					<div
						class="row slider-text justify-content-center align-items-center"
						...
						<div class="col-sm-12 ftco-animate text-center">
							<h1 class="mb-2">100% Original &amp; Quality products</h1>
			...
			<div class="row mb-5">
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						<h2 class="ftco-heading-2">Shopping Cart</h2>

		...
		<div class="row">
			<div class="col-md-6 offset-md-3">
				...
				<form action="productSave" method="post">
					...
					<div class="form-group">
						<label for="description">Enter Image Name</label> <input
							type="text" class="form-control" name="productImage"
							id="description" rows="5" placeholder="Enter the product image"
							required>
						</textarea>
					</div>
						...
						<label for="quantity">Quantity</label> <input type="number"
							...
							class="form-control" id="quantity" min="0" max="30000" required>

					</div>

					<div class="form-group">
						<label for="price">Product Price</label> <input type="number"
							placeholder="Enter the product price in number"
							name="productPrice" class="form-control" id="price" min="0"
							max="30000" required>

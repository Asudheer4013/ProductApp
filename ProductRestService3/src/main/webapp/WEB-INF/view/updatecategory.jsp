...
<body class="goto-here">
	...
	<div class="container mt-3">
		<div class="row">
			<div class="col-md-6 offset-md-3">
				<h1 class="text-center mb-3">Update Category</h1>
				<form action="updatecategorysave" method="post">
					<div class="form-group">
						<!-- 	<label for="productName">Category Name</label> -->
						<input type="hidden" class="form-control" name="catid" id="catid"
							value=${category.catid }
							rows="5"
							placeholder="Enter the categoryNamee" required></textarea>
					</div>

					<div class="form-group">
						<label for="productName">Category Name</label> <input type="text"

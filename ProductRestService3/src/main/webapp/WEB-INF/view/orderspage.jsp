	...
	<div class="container mt-3">
		<div class="row">
			<div class="col-md-12">
				...
				<h1 class="text-center mb-3">Ordered Products</h1>
				<table class="table">
					<thead>
						<tr>
					...
					<tbody>
						<c:forEach items="${ordersList}" var="c">

							<tr>
								<td><c:out value="${c.getOrderid() }" /></td>
								<td><c:out value="${c.getProduct().getProductName() }" /></td>
								<td><img src="/resources/${c.getProduct().getProductImage()}" width="50"></td>
								<td><c:out value="${c.getQuantity()}"/></td>
								<td><c:out value="${c.getProduct().getProductPrice()}"/></td>

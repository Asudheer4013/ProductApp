		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="container text-center">
					<a href="addcategory" class="btn btn-outline-success">Add
						Category</a>
				</div>
				<br>
				<table class="table">
					...
					<tbody>
						<c:forEach items="${categories}" var="c">
							 ...
							 <td><a href="delete/${c.getCatid()}"><i class="fas fa-trash text-danger"></i></a> 
							<a href="updatecategory?id=${c.getCatid()}"><i class="fas fa-pen-nib text-primary"></i></a>  </td>
